            ...
            if national.stage == event.stage {
                if national.start < local_finsh && national.finsh > local_start {
                    ...
                    let description = format!(
                        "{area_name} loadshedding:\n- from {}\n- to {}\n\nNational loadshedding:\n- from {}\n- to {}\n\nIncorrect? Make a suggestion here: https://github.com/beyarkay/eskom-calendar/edit/main/manually_specified.yaml\n\n---\nGenerated by Boyd Kane's Eskom-Calendar: https://github.com/beyarkay/eskom-calendar\n\nNational loadshedding information scraped from {}, {area_name} loadshedding information scraped from https://www.eskom.co.za/distribution/customer-service/outages/municipal-loadshedding-schedules/\n\nCalendar compiled at {:?}",
