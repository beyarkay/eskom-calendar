...
def main():
    ...
    # Drop unused columns
    pdf = pdf.drop(['City Power Load Shedding Schedule February 2021', 'Unnamed: 0'], axis=1)
    ...
    starts = [ '00:00', '02:00', '04:00', '06:00', '08:00', '10:00', '12:00', '14:00', '16:00', '18:00', '20:00', '22:00', ]
    finshs = [ '02:30', '04:30', '06:30', '08:30', '10:30', '12:30', '14:30', '16:30', '18:30', '20:30', '22:30', '00:30', ]
    ...
    for area_idx in sorted(pdf['area'].unique()):
        area_df = pdf[pdf['area'] == area_idx].sort_values(['date_of_month', 'start_time', 'stage'])
